-- GENERATED: Flattened baseline migration

-- >>> BEGIN supabase/schema/others/01_extensions.sql
...
-- <<< END supabase/schema/others/01_extensions.sql

-- >>> BEGIN supabase/schema/others/02_types.sql
...
-- <<< END supabase/schema/others/02_types.sql
...
-- >>> BEGIN supabase/schema/others/04_functions.sql
...
-- <<< END supabase/schema/others/04_functions.sql

-- >>> BEGIN supabase/schema/others/05_views.sql
...
-- <<< END supabase/schema/others/05_views.sql

-- >>> BEGIN supabase/schema/others/06_auth_hooks.sql
...
-- <<< END supabase/schema/others/06_auth_hooks.sql

-- >>> BEGIN supabase/schema/others/07_rls.sql
...
-- <<< END supabase/schema/others/07_rls.sql

-- >>> BEGIN supabase/schema/others/08_orphan_checks.sql
...
-- <<< END supabase/schema/others/08_orphan_checks.sql
