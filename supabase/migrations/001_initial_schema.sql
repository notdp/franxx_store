...
CREATE TABLE public.orders (
  ...
  phone TEXT,
  email TEXT NOT NULL,
  status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'processing', 'paid', 'delivered', 'failed', 'cancelled')),
  payment_method TEXT CHECK (payment_method IN ('alipay', 'wechat', 'paypal', 'stripe')),
